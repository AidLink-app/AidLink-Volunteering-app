...
public class DashboardActivity extends AppCompatActivity {
    ...
    private void replaceFragment(Fragment fragment) {
        ...
        if (fragment instanceof SettingsFragment) {
            recyclerView.setVisibility(View.GONE);  // Hide the RecyclerView when settings are shown
        } else {
            recyclerView.setVisibility(View.VISIBLE);  // Show the RecyclerView for other fragments
        }
